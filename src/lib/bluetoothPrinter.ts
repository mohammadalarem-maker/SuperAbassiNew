...
export class BluetoothPrinterService {
   ...
   */
  static async printInvoice(invoice: any, storeName = 'سوبر ماركت العباسي'): Promise<void> {
    ...
    const currencyHex = invoice.currency || 'YER';
    const cleanCurrency = (currencyHex === 'USD' || currencyHex === '$') ? '$' : ((currencyHex === 'SAR' || currencyHex === 'ر.س') ? 'ر.س' : 'ر.ي');
    ...
    appendText('سوبر ماركت العباسي - م/ محمد الصارم', 'center', false, false);

...
const translations: Record<string, string> = {
  ...
  'تطوير: م/ محمد الصارم - 2024': 'Developed by: Eng. Mazen Faraa - 2024',
  'تطوير المهندس:': 'Developed by Eng:',
  'محمد الصارم': 'Mazen Faraa',
  'نسيت كلمة المرور': 'Forgot Password',
  ...
  'إلغاء الأمر': 'Cancel',
  'مرحباً بك مجدداً في نظام م/ محمد الصارم': 'Welcome back to Eng. Mazen Faraa System',
  'أو': 'Or',
  'ر.ي': 'YER',
  'ر.س': 'SAR',
  '$': '$',

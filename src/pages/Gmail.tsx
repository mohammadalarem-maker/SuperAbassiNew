...
export default function Gmail() {
    ...
    try {
      ...
      const wrapper = `
        <div style="font-family: Arial; direction: rtl; text-align: right; padding: 20px;">
          <h2 style="color: #541919; border-bottom: 2px solid #541919; padding-bottom: 5px;">سوبر ماركت العباسي</h2>
  ...
  const applyTemplate = (type: 'invoice' | 'debt') => {
    if (type === 'invoice') {
      setComposeSubject('فاتورة مبيعات جديدة - متجر سوبر ماركت العباسي');
...
إذا كان لديك أي استفسار، تواصل معنا: 776591639.`);
      ...
      setComposeSubject('إشعار مديونية - متجر سوبر ماركت العباسي');
      setComposeBody(`الأخ الكريم،
نود تذكيركم بالمديونية القائمة المستحقة لمتجر سوبر ماركت العباسي. يرجى المراجعة للتسوية.

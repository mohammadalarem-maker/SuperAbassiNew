...
export default function UsersPage() {
  ...
  const openEditModal = (targetUser: ERPUser) => {
    ...
    if (targetUser.email === 'Mohammedalsarem6@gmail.com' && currentLoggedUser?.email !== 'Mohammedalsarem6@gmail.com') {
    ...
    setPassword(targetUser.password || 'Admintest');
  ...
  const handleDeleteUser = async (userToDelete: ERPUser) => {
    if (userToDelete.email === 'Mohammedalsarem6@gmail.com') {
    ...
    <div className="space-y-6 text-right" dir="rtl">
      ...
      {loading && users.length === 0 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
           {users.map((item) => {
             const isOwner = item.email === 'Mohammedalsarem6@gmail.com';
                 ...
                 <div className="space-y-3 pt-4 select-none">
                    ...
                    <div className="space-y-1 pt-2 border-t border-gray-50 dark:border-slate-850 text-xs font-semibold text-gray-500">
                       ...
                       <div className="flex items-center gap-1">
                          ...
                          <span>كلمة المرور: <strong className="text-secondary dark:text-amber-500 font-mono text-sm">{item.password || 'Admintest'}</strong></span>
                       </div>
                    </div>
                 </div>

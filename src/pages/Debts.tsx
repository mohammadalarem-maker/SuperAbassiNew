                  ...
                  <div className="flex items-center gap-1 flex-wrap">
                     ...
                     {target.customerPhone && (
                        <>
                           <button
                             onClick={() => {
                                const msg = `مرحباً يا غالي ${target.customerName}، نأمل أنك بخير. تذكير لطيف من متجر سوبر ماركت العباسي 📱 بخصوص المتبقي من حسابك وهو (${(target.amountRemaining || 0).toLocaleString()} ر.ي). شاكرين لك تعاملك الراقي وثقتك بنا، ويسعدنا تشريفك لنا في المحل لأي استفسار أو سداد. يومك سعيد! ✨`;

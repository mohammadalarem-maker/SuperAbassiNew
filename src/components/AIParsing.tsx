    ...
    <div className="space-y-8 animate-fadeIn" dir="rtl">
      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm">
        <h2 className="text-xl font-bold text-slate-800 flex items-center gap-2">
          ...
          مستورد مخزون العباسي بالذكاء الاصطناعي
        </h2>
        <p className="text-sm text-slate-500 mt-2 leading-relaxed">
          الصق قائمة المشتريات، كشف الفواتير، الرسائل، أو القوائم الواردة من الموردين بأي صيغة نصية عشوائية. سيقوم نظام العباسي بفهم النصوص تلقائياً واستخلاص المبيعات بالكامل، الكميات، الأسعار، الفئات، والرموز بضغطة زر واحدة.
        </p>

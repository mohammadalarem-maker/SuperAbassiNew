      ...
      <div className="lg:col-span-7 space-y-6">
        <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-100">
            <h2 className="text-xl font-bold text-slate-800">قائمة معروضات وهواتف نظام العباسي</h2>
        ...
        <div className="fixed inset-0 bg-slate-950/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-[2rem] w-full max-w-lg overflow-hidden border border-slate-200 shadow-2xl animate-scaleUp">
            ...
            <div className="bg-slate-900 text-white p-6 relative">
              <h3 className="text-xl font-bold font-sans">فاتورة مبيعات سوبر ماركت العباسي</h3>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="text-center space-y-1">
                ...
                <p className="text-[10px] text-slate-400 pt-3">شكرًا لتعاملكم مع سوبر ماركت العباسي • يرجى الاحتفاظ بالفاتورة للاسترجاع والضمان</p>
              </div>
            </div>
          </div>
        </div>

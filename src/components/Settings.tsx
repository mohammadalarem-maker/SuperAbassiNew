    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-fadeIn text-right" dir="rtl">
      ...
      <div className="bg-white border border-slate-200 rounded-[2rem] p-6 shadow-sm space-y-4">
        <h3 className="text-base font-bold text-slate-800 flex items-center gap-1.5">
          ...
          معاينة هوية نظام سوبر ماركت العباسي
        </h3>
        <p className="text-xs text-slate-400 leading-relaxed">
          يعد «نظام سوبر ماركت العباسي» علامة فارقة في الإدارة الرقمية لمتاجر الاتصالات. يقوم النظام تلقائياً بتطبيق الهوية البصرية الفخمة المستوحاة من اللونين الذهبي والداكن على الكاشير، الفواتير، ومستندات الطباعة لضمان ظهور المحل بمظهر راقي أمام العملاء والموردين.
        </p>
